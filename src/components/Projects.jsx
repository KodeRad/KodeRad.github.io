            ...
            <div className="container px-5 py-10 mx-auto text-center lg:px-40">
                <div className="flex flex-col w-full mb-20">
                    ...
                    <p className="mx-auto text-base leading-relaxed lg:w-2/3">
                        Here are some of the projects I&apos;ve built — crafted with care, creativity, and a drive to always keep improving.
                    </p>
                </div>
                    ...
                    {projects.map((project) => (
                        <a
                            ...
                            <div className="relative flex">
                                ...
                                />
                                <div
                                    className="relative z-10 w-full px-8 py-10 bg-gray-900 border-4 border-gray-800 opacity-0 hover:opacity-100">
                                    ...
                                    <p className="h-24 leading-relaxed">{project.description}</p>
                                </div>
                            </div>
                        </a>
                    ))}
